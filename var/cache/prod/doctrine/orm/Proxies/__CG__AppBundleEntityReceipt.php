...
class Recipe extends \AppBundle\Entity\Recipe implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Recipe' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Recipe' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Recipe' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Recipe' . "\0" . 'difficulty', '' . "\0" . 'AppBundle\\Entity\\Recipe' . "\0" . 'duration', '' . "\0" . 'AppBundle\\Entity\\Recipe' . "\0" . 'receipt', '' . "\0" . 'AppBundle\\Entity\\Recipe' . "\0" . 'type', '' . "\0" . 'AppBundle\\Entity\\Recipe' . "\0" . 'image', '' . "\0" . 'AppBundle\\Entity\\Recipe' . "\0" . 'video'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIngredients($video)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVideo', [$video]);

        return parent::setIngredients($video);
    }
